...
//3. Create 2 abstract classes Abs1 and Abs2 each with different implemented 
...
public class Temp extends Abs1  {//we cannot extend class from two abstract classes
